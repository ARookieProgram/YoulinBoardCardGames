    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('operator', '运营'), ('admin', '管理员'), ('super_admin', '超级管理员')], db_index=True, default='operator', max_length=20, verbose_name='角色')),
            ...
            options={
                ...
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['role', 'status'], name='idx_admin_role_status')],
            },
            managers=[
                ('objects', apps.accounts.models.AdminUserManager()),
            ],
        ),
    ]
